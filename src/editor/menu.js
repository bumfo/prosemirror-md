...
export function createMenuItems(schema) {
    return [
        ...
        [
            ...
            menuItem(
                '<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">\n' +
                '<path d="M16.0001 19.5648L20.8844 13.8663C21.4168 13.2452 21.683 12.9347 21.683 12.5648C21.683 12.1948 21.4168 11.8843 20.8844 11.2632L16.0001 5.56476M8.00006 19.5648L3.1157 13.8663C2.58333 13.2452 2.31714 12.9347 2.31714 12.5648C2.31714 12.1948 2.58333 11.8843 3.1157 11.2632L8.00006 5.56476" stroke="black" stroke-width="2" stroke-linejoin="round"/>\n' +
                '</svg>',
                'Code',
        ...
        [
            ...
            menuItem(
                '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"><defs><style>.cls-1{fill:none;stroke:#000;stroke-linecap:square;stroke-linejoin:round;stroke-width:2px;}</style></defs><g id="H"><line class="cls-1" x1="2.11" y1="12.08" x2="2.11" y2="3.62"/><line class="cls-1" x1="13.05" y1="12.08" x2="13.05" y2="21.45"/><polyline class="cls-1" points="13.05 3.62 13.05 12.08 2.11 12.08 2.11 21.45"/></g><g id="_1"><polyline class="cls-1" points="17.77 14.26 19.65 13.25 19.89 13.25 19.89 21.45"/></g></svg>',
                'Heading 1',
            ...
            menuItem(
                '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"><defs><style>.cls-1{fill:none;stroke:#000;stroke-linecap:square;stroke-linejoin:round;stroke-width:2px;}</style></defs><g id="H"><line class="cls-1" x1="2.11" y1="12.08" x2="2.11" y2="3.62"/><line class="cls-1" x1="13.05" y1="12.08" x2="13.05" y2="21.45"/><polyline class="cls-1" points="13.05 3.62 13.05 12.08 2.11 12.08 2.11 21.45"/></g><g id="_2"><path class="cls-1" d="M21.86,21.05h-4.71v-.16l.79-.77c2.24-2.13,3.3-3.3,3.32-4.77,0-1.3-.78-2.07-2.09-2.07-.68,0-1.26.26-1.67.52"/></g></svg>',
                'Heading 2',
            ...
            menuItem(
                '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25"><defs><style>.cls-1{fill:none;stroke:#000;stroke-linecap:square;stroke-linejoin:round;stroke-width:2px;}</style></defs><g id="H"><line class="cls-1" x1="2.11" y1="12.08" x2="2.11" y2="3.62"/><line class="cls-1" x1="13.05" y1="12.08" x2="13.05" y2="21.45"/><polyline class="cls-1" points="13.05 3.62 13.05 12.08 2.11 12.08 2.11 21.45"/></g><g id="_3"><path class="cls-1" d="M17.24,20.61c.42.19,1.04.39,1.71.39.93,0,1.47-.35,1.75-.64.35-.36.55-.87.54-1.39-.01-1.24-1.05-2.07-2.58-2.07,1.13,0,2.27-.62,2.27-1.81,0-.76-.49-1.65-1.86-1.65-.56,0-1.11.18-1.53.4"/></g></svg>',
                'Heading 3',
            ...
            menuItem(
                '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><defs><style>.cls-1{fill:none;stroke:#000;stroke-linejoin:round;stroke-width:2px;}</style></defs><path class="cls-1" d="M7.98,22.4c-2.24,0-3.33-1.02-3.33-3.12,0-.65.09-1.33.21-2.09.11-.73.22-1.47.22-2.21,0-1.42-.76-2.27-2.14-2.43,1.42-.15,2.14-.96,2.14-2.43,0-.77-.11-1.54-.21-2.28-.11-.78-.21-1.45-.21-2.14,0-1.97,1.12-2.96,3.33-2.96"/><path class="cls-1" d="M15.99,2.73c1.53,0,3.36.51,3.36,2.96,0,.69-.1,1.36-.2,2.07-.11.8-.22,1.57-.22,2.35,0,1.47.72,2.28,2.14,2.43-1.39.16-2.14,1.01-2.14,2.43,0,.75.11,1.5.22,2.21.11.76.21,1.44.21,2.09,0,2.1-1.09,3.12-3.33,3.12"/></svg>',
                'Code block',
        ...
        [
            menuItem(
                '<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">\n' +
                '<path d="M7.00009 5.56473L3.41431 9.15052C2.74764 9.81718 2.41431 10.1505 2.41431 10.5647C2.41431 10.9789 2.74764 11.3123 3.41431 11.9789L7.00009 15.5647M3.00009 10.5647L17.5001 10.5647C19.9854 10.5647 22.0001 12.5794 22.0001 15.0647C22.0001 17.55 19.9854 19.5647 17.5001 19.5647H10.0001" stroke="black" stroke-width="2"/>\n' +
                '</svg>',
                'Undo',
                undo,
                null,
            ...
            menuItem(
                '<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">\n' +
                '<path d="M17 5.56477L20.5858 9.15056C21.2525 9.81723 21.5858 10.1506 21.5858 10.5648C21.5858 10.979 21.2525 11.3123 20.5858 11.979L17 15.5648M21 10.5648L6.5 10.5648C4.01472 10.5648 2 12.5795 2 15.0648C2 17.5501 4.01472 19.5648 6.5 19.5648H14" stroke="black" stroke-width="2"/>\n' +
                '</svg>',
                'Redo',
                redo,
                null,
            ...
            menuItem(
                '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><defs><style>.cls-1{fill:none;fill-rule:evenodd;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:2px;}</style></defs><g id="Border"><path d="M14,1.56h-4v2h4V1.56ZM1,10.56v4h2v-4H1ZM10,23.56h4v-2h-4v2ZM23,14.56v-4h-2v4h2ZM14,23.56c1.86,0,3.35,0,4.52-.16,1.2-.16,2.21-.51,3.01-1.31l-1.41-1.41c-.37.37-.89.61-1.87.74-1.01.14-2.34.14-4.26.14v2ZM21,14.56c0,1.91,0,3.25-.14,4.26-.13.98-.37,1.5-.74,1.87l1.41,1.41c.8-.8,1.15-1.81,1.31-3.01.16-1.17.16-2.66.16-4.52h-2ZM1,14.56c0,1.86,0,3.35.16,4.52.16,1.2.51,2.21,1.31,3.01l1.41-1.41c-.37-.37-.61-.89-.74-1.87-.14-1.01-.14-2.34-.14-4.26H1ZM10,21.56c-1.91,0-3.25,0-4.26-.14-.98-.13-1.5-.37-1.87-.74l-1.41,1.41c.8.8,1.81,1.15,3.01,1.31,1.17.16,2.66.16,4.52.16v-2ZM10,1.56c-1.86,0-3.35,0-4.52.16-1.2.16-2.21.51-3.01,1.31l1.41,1.41c.37-.37.89-.61,1.87-.74,1.01-.14,2.34-.14,4.26-.14V1.56ZM3,10.56c0-1.91,0-3.25.14-4.26.13-.98.37-1.5.74-1.87l-1.41-1.41c-.8.8-1.15,1.81-1.31,3.01-.16,1.17-.16,2.66-.16,4.52h2ZM14,3.56c1.91,0,3.25,0,4.26.14.98.13,1.5.37,1.87.74l1.41-1.41c-.8-.8-1.81-1.15-3.01-1.31-1.17-.16-2.67-.16-4.52-.16v2ZM23,10.56c0-1.86,0-3.35-.16-4.52-.16-1.2-.51-2.21-1.31-3.01l-1.41,1.41c.37.37.61.89.74,1.87.14,1.01.14,2.34.14,4.26h2Z"/></g><g id="Image_line"><path class="cls-1" d="M2.11,16.94l2.67-2.66c.31-.31.73-.49,1.17-.49s.86.17,1.17.49l.42.42c.31.31.72.48,1.16.48s.85-.17,1.16-.48l2.69-2.69c.42-.42.97-.65,1.56-.65.32,0,.64.07.93.21l6.84,3.19"/><path class="cls-1" d="M8.15,9.28c-.31,0-.56-.25-.56-.56s.25-.56.56-.56.56.25.56.56-.25.56-.56.56Z"/></g></svg>',
                'Insert image',
                insertImageCommand(schema)
            ),
            menuItem(
                '<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">\n' +
                '<path d="M21 1.56476V7.56476C21 13.0876 16.5229 17.5648 11 17.5648H3.00002M7.00002 22.5648L3.06068 18.6254C2.47489 18.0396 2.47489 17.0899 3.06068 16.5041L7.00002 12.5648" stroke="black" stroke-width="2" stroke-linejoin="round"/>\n' +
                '</svg>',
                'Hard break',
